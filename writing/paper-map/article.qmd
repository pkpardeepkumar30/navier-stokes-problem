...
![The argument runs from a concentrating vortex to a smooth external force. The repair stage repeatedly addresses errors introduced by earlier repairs. This is a conceptual map, not a simulation.](figures/reader.png){#fig-map fig-alt="Six connected blocks: concentrate a vortex; join core to exterior; identify missing transport; prepare shear and add pulses; repair remaining errors; localize the result and keep the force smooth."}
